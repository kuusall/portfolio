      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="space-y-12">
          {config.projects.map((project, index) => (
            <div
              key={project.id}
              className="group relative overflow-hidden rounded-2xl border border-gray-200 dark:border-gray-800 bg-gray-50 dark:bg-[#111827]/50 p-8 transition-all duration-300 hover:border-cyan-600 dark:hover:border-cyan-400 hover:shadow-xl hover:shadow-cyan-500/5"
            >
              <div>
